...
1. Find the middle country(ies) in the [countries list](https://github.com/ethdevvinay/30daypythonbydev/tree/master/data/countries.py)
1. Divide the countries list into two equal lists if it is even if not one more country for the first half.
1. ['China', 'Russia', 'USA', 'India', 'Sweden', 'Norway', 'Denmark']. Unpack the first three countries and the rest as scandic countries.
