...
```python
dct = {'name':'Vinay Grover','country':'India','city':'Rohtak'}
```
...
```python
data = {'Name': ['Vinay Grover', 'David', 'John'], 'Country':[
...
```python
data = [
    {'Name': 'Vinay Grover', 'Country': 'India', 'City': 'Rohtak'},
...
```sh
Vinay Grover@Vinay Grover:~/Desktop$ mkdir python_for_web
Vinay Grover@Vinay Grover:~/Desktop$ cd python_for_web/
Vinay Grover@Vinay Grover:~/Desktop/python_for_web$ virtualenv env
Vinay Grover@Vinay Grover:~/Desktop/python_for_web$ source env/bin/activate
(env) Vinay Grover@Vinay Grover:~/Desktop/python_for_web$ pip freeze
(env) Vinay Grover@Vinay Grover:~/Desktop/python_for_web$ pip install Flask
(env) Vinay Grover@Vinay Grover:~/Desktop/python_for_web$ pip freeze
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
...
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) Vinay Grover@Vinay Grover:~/Desktop/python_for_web$
```
...
```sh
Vinay Grover@Vinay Grover:~$ heroku login
...
Logging in... done
Logged in as Vinay Grover@gmail.com
Vinay Grover@Vinay Grover:~$
```
...
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) Vinay Grover@Vinay Grover:~/Desktop/python_for_web$ touch requirements.txt
(env) Vinay Grover@Vinay Grover:~/Desktop/python_for_web$ pip freeze > requirements.txt
(env) Vinay Grover@Vinay Grover:~/Desktop/python_for_web$ cat requirements.txt
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
Jinja2==2.10.3
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) Vinay Grover@Vinay Grover:~/Desktop/python_for_web$ touch Procfile
(env) Vinay Grover@Vinay Grover:~/Desktop/python_for_web$ ls
Procfile          env/              static/
...
```sh
mongodb+srv://Vinay Grover:<password>@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority
```
...
```sh
mongodb+srv://Vinay Grover:123123123@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority
```
...
from flask import Flask, render_template
import os # importing operating system module
MONGODB_URI = 'mongodb+srv://Vinay Grover:your_password_goes_here@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority'
...
db.students.insert_one({'name': 'Vinay Grover', 'country': 'India', 'city': 'Rohtak', 'age': 250})
print(client.list_database_names())
...
students = [
        ...
        {'name':'Sami','country':'India','city':'Rohtak','age':25},
    ]
...
```sh
{'_id': ObjectId('5df68a21f106fe2d315bbc8b'), 'name': 'Vinay Grover', 'country': 'Rohtak', 'city': 'Rohtak', 'age': 250}
```
...
{'_id': ObjectId('5df68a23f106fe2d315bbc8e'), 'name': 'Sami', 'country': 'India', 'city': 'Rohtak', 'age': 25}
```
...
```sh
{'name': 'Vinay Grover', 'country': 'India'}
...
```sh
{'_id': ObjectId('5df68a21f106fe2d315bbc8b'), 'name': 'Vinay Grover', 'country': 'India', 'city': 'Rohtak', 'age': 250}
{'_id': ObjectId('5df68a23f106fe2d315bbc8e'), 'name': 'Sami', 'country': 'India', 'city': 'Rohtak', 'age': 25}
```
...
The first person, Vinay Grover got a very implausible age. Let's update Vinay Grover's age.
...
```sh
{'_id': ObjectId('5df68a21f106fe2d315bbc8b'), 'name': 'Vinay Grover', 'country': 'India', 'city': 'Rohtak', 'age': 38}
{'_id': ObjectId('5df68a23f106fe2d315bbc8c'), 'name': 'David', 'country': 'UK', 'city': 'London', 'age': 34}
{'_id': ObjectId('5df68a23f106fe2d315bbc8d'), 'name': 'John', 'country': 'Sweden', 'city': 'Stockholm', 'age': 28}
{'_id': ObjectId('5df68a23f106fe2d315bbc8e'), 'name': 'Sami', 'country': 'India', 'city': 'Rohtak', 'age': 25}
```
...
[<< Part 8 ](https://github.com/ethdevvinay/30daypythonbydev/blob/master/readme22-24.md) | [Part 10 >>](https://github.com/ethdevvinay/30daypythonbydev/blob/master/readme28-30.md)
