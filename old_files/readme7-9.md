...
print(person['first_name']) # Vinay Grover
...
print(person.get('first_name')) # Vinay Grover
...
* If the person is married and if he lives in India, print the following: 
    ```py
    Vinay Grover  lives in India. He is married.
    ```
[<< Part 2 ](https://github.com/ethdevvinay/30daypythonbydev/blob/master/readme4-6.md) | [Part 4 >>](https://github.com/ethdevvinay/30daypythonbydev/blob/master/readme10-12.md)
***