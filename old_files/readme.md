...
```py
{'name':'Vinay Grover', 'country':'India', age:250, 'is_married':True}
```
...
```py
('Vinay Grover', 'Brook', 'Abraham', 'Lidiya')
```
...
print(type('Vinay Grover'))  # String
print(type([1, 2, 3]))   # List
print(type({'name':'Vinay Grover'})) # Dictionary
...
print(type({'name':'Vinay Grover','age':250, 'is_married':250}))    # dict
...
print('A in Vinay Grover', 'A' in 'Vinay Grover') # True - A found in the string
print('B in Vinay Grover', 'B' in 'Vinay Grover') # False -there is no uppercase B
...
[Part 2 >>](https://github.com/ethdevvinay/30daypythonbydev/blob/master/readme4-6.md)
