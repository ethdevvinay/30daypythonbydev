...
```py
  def generate_full_name (first_name, last_name):
      ...
      full_name = first_name + space + last_name
      return full_name
  print('Full Name: ', generate_full_name('Vinay Grover',''))
...
```py
  def print_fullname(firstname, lastname):
        ...
        print(full_name)
  print_fullname(firstname='Vinay Grover', lastname='')
...
```py
  def print_name(firstname):
        return firstname
  print_name('Vinay Grover') # Vinay Grover

  def print_full_name(firstname, lastname):
        space = ' '
        full_name = firstname  + space + lastname
        return full_name
  print_full_name(firstname='Vinay Grover', lastname='')
```
* Returning Number:
...
```py
  ...
  def generate_full_name (first_name = 'Vinay Grover', last_name = ''):
      space = ' '
      full_name = first_name + space + last_name
      return full_name
...
def generate_groups (team,*args):
    ...
    for i in args:
        print(i)
generate_groups('Team-1','Vinay Grover','Brook','David','Eyob')
```
...
# main.py file
import mymodule
print(mymodule.generate_full_name('Vinay Grover', ''))
```
...
output
Welcome Vinay Grover. Enjoy  30DayOfPython challenge!
...
[<< Part 3 ](https://github.com/ethdevvinay/30daypythonbydev/blob/master/readme7-9.md) | [Part 5 >>](https://github.com/ethdevvinay/30daypythonbydev/blob/master/readme13-15.md)
***
