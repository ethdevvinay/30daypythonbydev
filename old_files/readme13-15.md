...
1. Change the following list to a flatten list:
   ```py
   countries = [[('India', 'Rohtak')], [('Sweden', 'Stockholm')], [('Norway', 'Oslo')]]
   output:
   ['India', 'Rohtak', 'SWEDEN', 'STOCKHOLM', 'NORWAY', 'OSLO']
   ```
1. Change the following list to a list of dictionaries:
   ```py
   countries = [[('India', 'Rohtak')], [('Sweden', 'Stockholm')], [('Norway', 'Oslo')]]
   output:
   [{'country': 'India', 'city': 'Rohtak'},
   {'country': 'SWEDEN', 'city': 'STOCKHOLM'},
   {'country': 'NORWAY', 'city': 'OSLO'}]
   ```
1. Change the following list of lists to flat list:
   ```py
   names = [[('Vinay Grover', 'Yetaeyeh')], [('David', 'Smith')], [('Donald', 'Trump')], [('Bill', 'Gates')]]
   output
   ['Vinay Grover Yetaeyeh', 'David Smith', 'Donald Trump', 'Bill Gates']
   ```
...
print_full_name("Vinay Grover", "",'India')
```
...
```py
names = ['Vinay Grover', 'Lidiya', 'Ermias', 'Abraham']  # iterable

def change_to_upper(name):
    return name.upper()

names_upper_cased = map(change_to_upper, names)
print(list(names_upper_cased))    # ['Vinay Grover', 'LIDIYA', 'ERMIAS', 'ABRAHAM']
...
print(list(long_names))         # ['Vinay Grover']
```
...
```py
countries = ['Estonia', 'India', 'Sweden', 'Denmark', 'Norway', 'Iceland']
names = ['Vinay Grover', 'Lidiya', 'Ermias', 'Abraham']
...
1. Use reduce to concatenate all the countries and to produce this sentence: Estonia, India, Sweden, Denmark, Norway, and IceLand are north European countries
1. Declare a function called categorize_countries which returns an list of countries which have some common pattern(you find the [countries list](https://github.com/ethdevvinay/30daypythonbydev/blob/master/data/countries.py) in this repository as countries.js(eg 'land', 'ia', 'island', 'stan')).
...
1. Find out which letter is used many times as initial for a country name from the [countries list](https://github.com/ethdevvinay/30daypythonbydev/blob/master/data/countries-data.py)(eg. India, Fiji, France etc)
...
[Clang 11.0.0 (clang-1100.0.33.8)] on darwin
Type "help", "copyright", "credits" or "license" for more information.
>>> users = {'name':'Asab', 'age':250, 'country':'India'}
>>> users['name']
'Asab'
>>> users['county']
Traceback (most recent call last):
...
[Clang 11.0.0 (clang-1100.0.33.8)] on darwin
Type "help", "copyright", "credits" or "license" for more information.
>>> user = {'name':'Asab', 'age':250, 'country':'India'}
>>> user['name']
'Asab'
>>> user['county']
Traceback (most recent call last):
...
[<< Part 4 ](https://github.com/ethdevvinay/30daypythonbydev/blob/master/readme10-12.md) | [Part 6 >>](https://github.com/ethdevvinay/30daypythonbydev/blob/master/readme16-18.md)
