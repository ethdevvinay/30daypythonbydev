...
print(sentence) # I am Vinay Grover . I am a teacher. I live in India.
...
```py
 lst = ['Vinay Grover', 250, True, {'country':'India', 'city':'Rohtak'}] # list containing different data types
```
...
countries = ['Germany', 'France','Belgium','Sweden','Denmark','India','Norway','Iceland','Estonia']
...
29. Find the middle country(ies) in the [countries list](https://github.com/ethdevvinay/30daypythonbydev/tree/master/data/countries.py)
30. Divide the countries list into two equal lists if it is even if not one more country for the first half.
31. ['China', 'Russia', 'USA', 'India', 'Sweden', 'Norway', 'Denmark']. Unpack the first three countries and the rest as scandic countries.
...
[<< Part 1](https://github.com/ethdevvinay/30daypythonbydev/blob/master/readme.md) | [Part 3>>](https://github.com/ethdevvinay/30daypythonbydev/blob/master/readme7-9.md)