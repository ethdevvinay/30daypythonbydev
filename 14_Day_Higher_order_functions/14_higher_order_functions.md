...
1. Declare a function called categorize_countries that returns a list of countries with some common pattern (you can find the [countries list](https://github.com/ethdevvinay/30daypythonbydev/blob/master/data/countries.py) in this repository as countries.js(eg 'land', 'ia', 'island', 'stan')).
...
1. Use the countries_data.py (https://github.com/ethdevvinay/30daypythonbydev/blob/master/data/countries-data.py) file and follow the tasks below:
